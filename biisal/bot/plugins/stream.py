...
<b>⚠️ ᴛʜɪꜱ ʟɪɴᴋ ᴡɪʟʟ ᴇxᴘɪʀᴇ ᴀꜰᴛᴇʀ 12 ʜᴏᴜʀꜱ</b>

<b>❇️ Power By  : @Botmaster_55</b>"""
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  Contact Developer [MASTER](https://telegram.me/Botmaster55) he will help you.",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ʙᴏss](https://telegram.me/Botmaster55)",
                disable_web_page_preview=True
            )
            return
